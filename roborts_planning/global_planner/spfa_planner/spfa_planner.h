...
namespace roborts_global_planner{
	 ...
	 */
	void GetEightNeighbors(const int &current_index,
	...
	struct Compare {
		bool operator()(const int &index1, const int &index2) {
 			return SPFAPlanner::dis_.at(index1) > SPFAPlanner::dis_.at(index2);
		}
	};
...
std::vector<int> SPFAPlanner::dis_;
...
#endif // ROBORTS_PLANNING_GLOBAL_PLANNER_SPFA_PLANNER_H
